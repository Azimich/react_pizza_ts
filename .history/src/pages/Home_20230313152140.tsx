...
import { selectFilter, setCategoryId, setCurrentPage } from 'src/redux/slices/fiterSlice';
...
const Home: FC = () => {
  ...
  const pizzas = items.map((obj: object) => <PizzaBlock key={obj.id} {...obj} />);
      ...
      { status === 'error' ? (
        <div className='error_404'>
          <svg width="784" height="480" viewBox="0 0 784 480" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <path d="M25.7886 362.507L760.239 362.507" stroke="#FE5F1E" strokeWidth="2.4729" strokeMiterlimit="10"/>
          </svg>
        </div>
      ) : (
