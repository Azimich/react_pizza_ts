...
const CartItemBlock: FC <ICartItemProps> = ({ id, title, type, price, count, imageUrl, size }) => {
  ...
  const onClickRemove = () => {
    if (window.confirm('Ты чё, серьёзно хочешь удалить эту вкусняшку? 😒')) {
  ...
  return (
    <div className="cart__item">
      ...
      <div className="cart__item-count">
        <button disabled={count} onClick={onClickMinus} className="button button--outline button--circle cart__item-count-minus">
